function [a,b,gamma,donothing,dnew]=NR_Fast_Givens_Compute(f,g,di,dk)
% function [a,b,gamma,donothing,dnew]=NR_Fast_Givens_Compute(f,g,di,dk)
...
% See also NR_Fast_Givens. Verify with NR_Fast_Givens_Test.
...
end % function NR_Fast_Givens_Compute
