% script <a href="matlab:NR_GaussEchelonTest">NR_GaussEchelonBinaryFieldTest</a>
% Test <a href="matlab:help NR_GaussEchelon">NR_GaussEchelon</a> on a matrix with m=4, n=5, and r=3.
...
% See also NR_GaussPPTest.

disp('Now testing NR_GaussEchelonBinaryFieldTest on a matrix with m=4, n=5, and r=3.')
A=[ 0  0  3  9  3;  -1 -2  2  0  5;  2  4 -1 -3  5;  1  2  1 -3 10]  % See (2.12)
[m,n]=size(A);  [Amod,p,r,v,R] = NR_GaussEchelon(A);
...
% end script NR_GaussEchelonTest
