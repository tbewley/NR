% script <a href="matlab:NR_ThomasParallelTest">NR_ThomasParallelTest</a>
% Test <a href="matlab:help NR_ThomasParallel">NR_ThomasParallel</a> on a random tridiagonal matrix.
...
% See also NR_ThomasTest, NR_ThomasTTTest, NR_CirculantTest.

disp('Now testing NR_ThomasParallel on a random tridiagonal matrix.')
...
disp(sprintf('\nNow checking NR_ThomasParallel using %d threads, aka "labs", taking n= %d',p,n))
tic; [x]=NR_ThomasParallel(a,b,c,g,n,p); toc; A*x, g, error=norm(A*x-g)
...
a=randn(n,1); b=randn(n,1); c=randn(n,1); g=randn(n,1); a(1)=0; c(n)=0; 
disp(sprintf('\nNow timing NR_ThomasParallel using %d threads taking n= %4.2e',p,n))
tic; [x]=NR_ThomasParallel(a,b,c,g,n,p); toc;
...
% end script NR_ThomasParallelTest
