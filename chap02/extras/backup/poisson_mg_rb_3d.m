...
for i=1:N1; poisson_rb(1); end
tic;
for iter=1:10 
   o=e;  poisson_mg(1); e = max_error(1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function poisson_mg(lev)
global XBC YBC ZBC N1 N2 N3 xo yo zo nlev d v g
for i=1:N2; poisson_rb(lev); end 
...
if (lev<nlev-1),   poisson_mg(lev+1)       % Continue to even coarser grid, or
else, for i=1:20;  poisson_rb(nlev); end   % solve coarsest system (almost exactly)
end
...
end; end; end    % Note that the next call to poisson_rb takes care of red points
enforce_bcs(lev)
for i=1:N3; poisson_rb(lev); end
% end function poisson_mg
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function poisson_rb(lev);              % Apply Red/Black Gauss-Seidel, with L from Poisson
global XBC YBC ZBC N1 N2 N3 xo yo zo nlev d v g
