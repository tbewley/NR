...
for i=1:N1; NR_poisson_rb(1); end
tic;
for iter=1:10 
   o=e;  NR_poisson_mg(1); e = max_error(1);
...
% end function NR_poisson_mg_rb_3d
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function NR_poisson_mg(lev)
global XBC YBC ZBC N1 N2 N3 xo yo zo nlev d v g
for i=1:N2; NR_poisson_rb(lev); end 
...
if (lev<nlev-1),   NR_poisson_mg(lev+1)       % Continue to even coarser grid, or
else, for i=1:20;  NR_poisson_rb(nlev); end   % solve coarsest system (almost exactly)
end
...
end; end; end    % Note that the next call to NR_poisson_rb takes care of red points
enforce_bcs(lev)
for i=1:N3; NR_poisson_rb(lev); end
% end function NR_poisson_mg
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function NR_poisson_rb(lev);              % Apply Red/Black NR_Gauss-Seidel, with L from Poisson
global XBC YBC ZBC N1 N2 N3 xo yo zo nlev d v g
