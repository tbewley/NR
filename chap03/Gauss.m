function [B,A] = NR_Gauss(A,B,n)
% function [B,A] = NR_Gauss(A,B,n)
% Solve AX=B for X using NR_Gaussian elimination without pivoting.  The matrix B is replaced
...
% See also NR_GaussLU. Verify with NR_GaussTest.
