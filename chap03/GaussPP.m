function [B,A,p] = NR_GaussPP(A,B,n)
% function [B,A,p] = NR_GaussPP(A,B,n)
% This function solves AX=B for X using NR_Gaussian elimination with partial pivoting.
...
% See also NR_GaussPLU. Verify with NR_GaussPPTest, Example_2_1.
...
% --- THE REMAINDER OF THIS FUNCTION IS IDENTICAL TO NR_Gauss.m ---
% ...
