function [G] = NR_ThomasTT(a,b,c,G,n)
% function [G] = NR_ThomasTT(a,b,c,G,n)
...
% Verify with <a href="matlab:help NR_ThomasTTTest">NR_ThomasTTTest</a>.
...
G(n,:) = G(n,:) / bt(n);               % BACK SUNR_BSTITUTION
for i = n-1:-1:1,
   G(i,:) = ( G(i,:) - c * G(i+1,:) ) / bt(i);
end
end % function NR_ThomasTT
