...
% See also NR_CALE, NR_CARE, NR_DARE. Depends on NR_Schur, NR_GaussPP.
% Verify with NR_DALEtest.

n=length(F); [U,T]=NR_Schur(F'); F0=T'; Q0=U'*Q*U; X0=NR_DALEtri(F0,Q0,n); X=U*X0*U';
