% script <a href="matlab:NR_EigRealTest">NR_EigRealTest</a>
% Test <a href="matlab:help NR_EigReal">NR_EigReal</a>, together with <a href="matlab:help NR_ShiftedInversePower">NR_ShiftedInversePower</a>, on a random matrix.
...
disp('Now testing NR_EigReal, together with NR_ShiftedInversePower, on a random matrix.')
