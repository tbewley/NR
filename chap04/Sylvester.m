function X=NR_Sylvester(A,B,C,g,m,n)
% function X=NR_Sylvester(A,B,C,g,m,n)
...
% See also NR_Sylvester. Depends on NR_Schur, NR_GaussPP.
% Verify with NR_SylvesterTest.

[U,A0]=NR_Schur(A); [V,B0]=NR_Schur(B); C0=U'*C*V; X0=NR_SylvesterTri(A0,B0,C0,g,m,n); X=U*X0*V';
end % function NR_Sylvester
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function X=NR_SylvesterTri(A,B,C,g,m,n)                 % Numerical Renaissance Codebase 1.0
