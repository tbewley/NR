function [bv] = EigHermitian(A)
% [lambda]=EigHermitian(A) for an NxN Hermitian A with |lambda_1|>|lambda_2|>... 
% computes the eigenvalues lambda.  
% After an initial Hessenberg decomposition, several explicitly-shifted QR steps
...
end; if step==20*n, disp('EigHermitian did not converge'), end
