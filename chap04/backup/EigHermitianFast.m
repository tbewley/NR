function [bv] = NR_EigHermitian(A)
% [lambda]=NR_EigHermitian(A) for an NxN Hermitian A with |lambda_1|>|lambda_2|>... 
% computes the eigenvalues lambda.  
% After an initial NR_Hessenberg decomposition, several explicitly-shifted QR steps
...
end; if step==20*n, disp('NR_EigHermitian did not converge'), end
