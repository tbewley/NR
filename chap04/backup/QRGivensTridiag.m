function [b,c,a,cc,ss] = NR_QRGivensTridiag(a,b,c)
% function [b,c,a,cc,ss] = NR_QRGivensTridiag(a,b,c)
...
% is more efficient in this case than returning Q itself (which is upper NR_Hessenberg).
% Numerical Renaissance Codebase 1.0, Chapter 4; see text for copyleft info.

n=size(b); for i=1:n-1, [cc(i),ss(i)]=NR_RotateCompute(b(i),a(i+1)); if cc(i)~=1
...
end % function NR_QRGivensTridiag