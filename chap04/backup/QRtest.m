% script TestQR                                      % Numerical Renaissance Codebase 1.0
...
[R,Q]=QRFastGivensHessenberg(C); nonorthogonality=norm(Q'*Q-eye(size(Q'*Q))), residual=norm(Q*R-C),
...
tic; [R,Q]=QRFastGivensHessenberg(D); toc,
