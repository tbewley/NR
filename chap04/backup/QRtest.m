% script NR_TestQR                                      % Numerical Renaissance Codebase 1.0
...
[R,Q]=NR_QRFastGivensHessenberg(C); nonorthogonality=norm(Q'*Q-eye(size(Q'*Q))), residual=norm(Q*R-C),
...
tic; [R,Q]=NR_QRFastGivensHessenberg(D); toc,
