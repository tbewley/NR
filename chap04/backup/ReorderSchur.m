function [U,T]=NR_ReorderSchur(U,T,type,e)
% function [U,T]=NR_ReorderSchur(U,T,type,e)
% This function reorders a NR_Schur decomposition such that the stable eigenvalues appear
...
if m>1                                                     % make new T22 upper triangular
  ...
  [V,temp]=NR_Schur(Q12'*T11*(Q12-Q11*R11*Q22/g));  Q(:,p+1:p+m)=Q(:,p+1:p+m)*V;                             
