% script <a href="matlab:NR_FFTdirectTest">NR_FFTdirectTest</a>
% Test <a href="matlab:help FFTdirect">NR_FFTdirect</a> with random real and complex u.
...
for i=1:2
  if i==1, disp('Now testing NR_FFTdirect on a random real vector')
  else, disp('Now testing NR_FFTdirect on a random complex vector'), end
  u=v(:,i); uhat=NR_FFTdirect(u,N,-1); u1=NR_FFTdirect(uhat,N,1);
