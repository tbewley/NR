% script <a href="matlab:NR_FFTrecursiveTest">NR_FFTrecursiveTest</a> 
% Test <a href="matlab:help NR_FFTrecursive">NR_FFTrecursive</a> with random u.
...
for i=1:2
  if i==1, disp('Now testing NR_FFTrecursive on a random real vector')
  else, disp('Now testing NR_FFTrecursive on a random complex vector'), end
  u=v(:,i); uhat=NR_FFTrecursive(u,N,-1)/N; u1=NR_FFTrecursive(uhat,N,1);
...
% end script NR_FFTrecursiveTest
