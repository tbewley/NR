...
% See also NR_RFFT1inv, NR_RFFT2, NR_RFFT.  Verify with: NR_RFFT1Test.

[uehat,uohat]=NR_RFFT2(u(1:2:N-1),u(2:2:N),N/2);  % Compute FFTs of the even and
