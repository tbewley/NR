% script <a href="matlab:NR_RFFT2Test">RFFT2Test</a>
% Test <a href="matlab:help NR_RFFT2">RFFT2</a> and <a href="matlab:help NR_RFFT2inv">NR_RFFT2inv</a> with random u and v.
...
% See also NR_RFFT1Test, NR_RFFTTest.

disp('Now testing NR_RFFT2 and NR_RFFT2inv on two random real vectors')
N=16; u=randn(N,1); v=randn(N,1); [uhat,vhat]=NR_RFFT2(u,v,N); [u1,v1]=NR_RFFT2inv(uhat,vhat,N);
