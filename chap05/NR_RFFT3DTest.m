% script <a href="matlab:NR_RFFT3DTest">NR_RFFT3DTest</a>
% Test <a href="matlab:help NR_RFFT3D">NR_RFFT3D</a> and <a href="matlab:help NR_RFFT3Dinv">NR_RFFT3Dinv</a> on a real 2D field that looks like an egg carton.
...
% See also NR_RFFTtest.

disp('Now testing NR_RFFT3D and NR_RFFT3Dinv on a real 2D field that looks like an egg carton')
...
uhat=NR_RFFT3D(u,NX,NY,NZ); u1=NR_RFFT3Dinv(uhat,NX,NY,NZ); % Transform, and transform back.
