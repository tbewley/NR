function [v1hat,v2hat,v3hat]=NR_RemoveDivergence(v1hat,v2hat,v3hat,NX,NY,NZ,KX,KY,KZ)
% function [v1hat,v2hat,v3hat]=NR_RemoveDivergence(v1hat,v2hat,v3hat,NX,NY,NZ,KX,KY,KZ)
...
% See also NR_ComputeDivergence.  Verify with: NR_RemoveDivergenceTest.
...
end % function NR_RemoveDivergence
