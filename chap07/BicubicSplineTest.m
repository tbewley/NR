% script <a href="matlab:BicubicSplineTest">BicubicSplineTest</a>
% Test <a href="matlab:help BicubicSpline">BicubicSpline</a> on data from a smooth fn.
...
[fx,fy,fxy,Ainv]=BicubicSplineSetup(xd,yd,fd,'parabolic');
BCS=BicubicSpline(x,y,xd,yd,fd,fx,fy,fxy,Ainv); figure(3), mesh(y,x,BCS), view(-11.5,14)

% end script BicubicSplineTest
