% script <a href="matlab:NR_BilinearSplineTest">NR_BilinearSplineTest</a>
% Test <a href="matlab:help NR_BilinearSpline">NR_BilinearSpline</a> on data from a smooth fn.
...
BLS=NR_BilinearSpline(x,y,xd,yd,fd); figure(3); mesh(y,x,BLS), view(-11.5,14)

% end script NR_BilinearSplineTest
