% script <a href="matlab:NR_PolyharmonicSplineTest">NR_PolyharmonicSplineTest</a>
% Test <a href="matlab:help NR_PolyharmonicSpline">NR_PolyharmonicSpline</a> on data from a smooth fn.
...
for k=1:kmax, figure(k), grid on, hold on
  [w,v]=NR_PolyharmonicSplineSetup(c,f,k);                 % initialize weights of the spline
  for i=1:Nx, for j=1:Ny
    fi(i,j,k)=NR_PolyharmonicSpline([x(i); y(j)],c,v,w,k); % calculate interpolant
...
% end script NR_PolyharmonicSplineTest
