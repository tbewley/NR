function [D,index]=NR_QuickSort(D,v,i,k) 
% function [D,index]=NR_QuickSort(D,v,i,k)
...
% See also NR_InsertionSort, NR_BlockInsertionSort, NR_MergeSort, NR_HeapSort, NR_CocktailSort,
% NR_BitonicSort, NR_OddEvenNR_MergeSort.  Verify with NR_QuickSortTest.
...
if k>i  % Begin by identifying a pivot.  Take the median of i=left, j=middle, and k=right.
  ...
  D=NR_QuickSort(D,v,i,pivot-1); D=NR_QuickSort(D,v,pivot+1,k); % Sort to left & right of pivot.
end
