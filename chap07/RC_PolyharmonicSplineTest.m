% script <a href="matlab:RC_PolyharmonicSplineTest">RC_PolyharmonicSplineTest</a>
% Test <a href="matlab:help RC_PolyharmonicSpline">RC_PolyharmonicSpline</a> on data from a smooth fn.
...
for k=1:kmax, figure(k), grid on, hold on
  [w,v]=RC_PolyharmonicSplineSetup(c,f,k);                 % initialize weights of the spline
  for i=1:Nx, for j=1:Ny
    fi(i,j,k)=RC_PolyharmonicSpline([x(i); y(j)],c,v,w,k); % calculate interpolant
...
% end script RC_PolyharmonicSplineTest
