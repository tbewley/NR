...
% See also BSTinitialize, BSTinsert, BSTplot, BSTenumerate, BSTsuccessor.
% Verify with BSTtest.
...
if     Dppg>Drg, [D,q]=BSTrotateRight(D,q);
elseif Drrg>Dpg, [D,q]=BSTrotateLeft(D,q); end
end % function BSTbalance1                               
