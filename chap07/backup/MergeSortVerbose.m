function MergeSortVerbose(a,b)                       % Numerical Renaissance Codebase 1.0
global D n speed frame
if b-a > 0
  b1 = a + floor((b-a)/2); a1=b1+1; MergeSortVerbose(a,b1), MergeSortVerbose(a1,b)
  while b1-a >= 0 & b-a1 >= 0
