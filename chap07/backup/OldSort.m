...
function [left,right] = NR_QuickSort(left, right)  % This function is recursive.
global D n speed
if right > left
  ...
  NR_QuickSort(left, newpivot-1)
  NR_QuickSort(newpivot+1, right)
end
% end function Quicksort
         
function NR_MergeSort(left, right)
global D n speed
if right-left > 0
  rightA = left + floor((right-left)/2); leftB=rightA+1;
  NR_MergeSort(left,rightA)
  NR_MergeSort(leftB,right)
