function [g,delta] = SplineSetup(x_data,y_data,n)    % Numerical Renaissance Codebase 1.0
...
elseif end_conditions==3   % Periodic end conditions
   ...
   a(n)=-1; b(n)=0; c(n)=1; g(n)=0;  [g]=Circulant(a,b,c,g,n); 
end
end % function SplineSetup.m
