function [g,delta] = NR_SplineSetup(x_data,y_data,n)    % Numerical Renaissance Codebase 1.0
...
elseif end_conditions==3   % Periodic end conditions
   ...
   a(n)=-1; b(n)=0; c(n)=1; g(n)=0;  [g]=NR_Circulant(a,b,c,g,n); 
end
end % function NR_SplineSetup.m
