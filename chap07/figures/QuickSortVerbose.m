function NR_QuickSortVerbose(i, k)                      % Numerical Renaissance Codebase 1.0
...
if k > i       
  ...
  NR_QuickSortVerbose(i,pivot-1); NR_QuickSortVerbose(pivot+1,k)    % Sort to the left and right of new pivot.
end
end % function NR_QuickSortVerbose