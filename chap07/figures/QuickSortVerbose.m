function QuickSortVerbose(i, k)                      % Numerical Renaissance Codebase 1.0
...
if k > i       
  ...
  QuickSortVerbose(i,pivot-1); QuickSortVerbose(pivot+1,k)    % Sort to the left and right of new pivot.
end
end % function QuickSortVerbose