function [x,t,s]=AB5(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=AB5(R,x,t,s,p,v,SimPlot)
...
% and the 5 most recent values of f on output (facilitating a subsequent call to AB5/AB6).
...
% See also EE, AB2, AB3, AB4, AB6.  Verify with ABtest.
