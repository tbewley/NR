function [x,t,s]=NR_AM3iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=NR_AM3iter(R,x,t,s,p,v,SimPlot)
...
% which contains the 2-3 most recent values of f on input (from a call to AM2iter/NR_AM3iter),
% and the 3 most recent values of f on output (facilitating a call to NR_AM3iter/NR_AM4iter).
...
% See also NR_CNiter, NR_AM4iter, NR_AM5iter, NR_AM6iter.  Verify with NR_AMtest.
