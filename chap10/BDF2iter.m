function [x,t,s]=BDF2iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=BDF2iter(R,x,t,s,p,v,SimPlot)
...
% the 2 (or more) most recent values of x on input (from a call to IEiter/BDF2iter),
% and the 3 most recent values of x on output (facilitating a call to BDF2iter/BDF3iter).
...
% See also IEiter, BDF3iter, BDF4iter, BDF5iter, BDF6iter.  Verify with BDFtest.
