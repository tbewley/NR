function [x,t,s]=NR_BDF4iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=NR_BDF4iter(R,x,t,s,p,v,SimPlot)
...
% the 4 (or more) most recent values of x on input (from a call to NR_BDF3iter/NR_BDF4iter),
% and the 5 most recent values of x on output (facilitating a call to NR_BDF4iter/NR_BDF5iter).
...
% See also NR_IEiter, NR_BDF2iter, NR_BDF3iter, NR_BDF5iter, NR_BDF6iter.  Verify with NR_BDFtest.
