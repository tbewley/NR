function NR_BDFtest
% function <a href="matlab:NR_BDFtest">NR_BDFtest</a>
% Test <a href="matlab:help NR_IEiter">NR_IEiter</a>, <a href="matlab:help NR_BDF2iter">NR_BDF2iter</a>, <a href="matlab:help NR_BDF3iter">NR_BDF3iter</a>, <a href="matlab:help NR_BDF4iter">NR_BDF4iter</a>, <a href="matlab:help NR_BDF5iter">NR_BDF5iter</a>, and <a href="matlab:help NR_BDF6iter">NR_BDF6iter</a>
...
format long; while 1                           
  ...
  disp('  Available methods: NR_IEiter, NR_BDF2iter, NR_BDF3iter, NR_BDF4iter, NR_BDF5iter, NR_BDF6iter')
  ...
  t=0; s.MaxSteps=1;  % PERFORM (order-1) STEPS USING LOWER-ONR_RDER BDF SCHEMES TO SET UP s.f
  if order>1, [x,t,s]=NR_IEiter  (strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>2, [x,t,s]=NR_BDF2iter(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>3, [x,t,s]=NR_BDF3iter(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>4, [x,t,s]=NR_BDF4iter(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>5, [x,t,s]=NR_BDF5iter(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  s.MaxSteps=1e6;
  [x,t]=feval(m,strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); x(:,1), t     % SIMULATE!
end, disp(' '), format short
end % function NR_BDFtest
