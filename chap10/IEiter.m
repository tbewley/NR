function [x,t,s]=IEiter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=IEiter(R,x,t,s,p,v,SimPlot)
...
% and the 2 most recent values of x on output (facilitating a call to BDF2iter).
...
% See also BDF2iter, BDF3iter, BDF4iter, BDF5iter, BDF6iter.  Verify with BDFtest.
