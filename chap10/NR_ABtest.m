function NR_ABtest
% function <a href="matlab:NR_ABtest">NR_ABtest</a>
% Test <a href="matlab:help EE">EE</a>, <a href="matlab:help AB2">AB2</a>, <a href="matlab:help AB3">AB3</a>, <a href="matlab:help AB4">AB4</a>, <a href="matlab:help AB5">AB5</a>, and <a href="matlab:help NR_AB6">NR_AB6</a>
...
format long; while 1                           
  ...
  disp('  Available methods: EE, AB2, AB3, AB4, AB5, NR_AB6')
  ...
  t=0; s.MaxSteps=1;  % PERFORM (order-1) STEPS USING LOWER-ONR_RDER AB SCHEMES TO SET UP s.f
  if order>1, [x,t,s]=NR_EE (strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>2, [x,t,s]=NR_AB2(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>3, [x,t,s]=NR_AB3(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>4, [x,t,s]=NR_AB4(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  if order>5, [x,t,s]=NR_AB5(strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler'); end
  s.MaxSteps=1e6;
  [x,t]=feval(m,strcat('RHS_',S),x,t,s,p,v,'PlotLorenzRossler')                % SIMULATE!
end, disp(' '), format short
end % function NR_ABtest
