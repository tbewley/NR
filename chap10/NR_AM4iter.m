function [x,t,s]=NR_AM4iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=NR_AM4iter(R,x,t,s,p,v,SimPlot)
...
% which contains the 3-4 most recent values of f on input (from a call to NR_AM3iter/NR_AM4iter),
% and the 4 most recent values of f on output (facilitating a call to NR_AM4iter/NR_AM5iter).
...
% See also NR_CNiter, NR_AM3iter, NR_AM5iter, NR_AM6iter.  Verify with NR_AMtest.
