function [x,t,s]=NR_AM5iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=NR_AM5iter(R,x,t,s,p,v,SimPlot)
...
% which contains the 4-5 most recent values of f on input (from a call to NR_AM4iter/NR_AM5iter),
% and the 5 most recent values of f on output (facilitating a call to NR_AM5iter/NR_AM6iter).
...
% See also NR_CNiter, NR_AM3iter, NR_AM4iter, NR_AM6iter.  Verify with NR_AMtest.
