function [x,t,s]=NR_AM6iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=NR_AM6iter(R,x,t,s,p,v,SimPlot)
% Simulate x'=f(x), with f implemented in R, using the iterative AM6 method with an NR_AB6
...
% which contains the 5 most recent values of f on input (from a call to NR_AM5iter/NR_AM6iter),
% and the 6 most recent values of f on output (facilitating a call to NR_AM6iter).
...
% See also NR_CNiter, NR_AM3iter, NR_AM4iter, NR_AM5iter.  Verify with NR_AMtest.
