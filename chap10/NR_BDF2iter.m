function [x,t,s]=NR_BDF2iter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=NR_BDF2iter(R,x,t,s,p,v,SimPlot)
...
% the 2 (or more) most recent values of x on input (from a call to NR_IEiter/NR_BDF2iter),
% and the 3 most recent values of x on output (facilitating a call to NR_BDF2iter/NR_BDF3iter).
...
% See also NR_IEiter, NR_BDF3iter, NR_BDF4iter, NR_BDF5iter, NR_BDF6iter.  Verify with NR_BDFtest.
