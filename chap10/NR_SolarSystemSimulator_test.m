...
for i=1:3 
	...
	[q,e]=NR_SolarSystemSimulator('SI4',Tmax,kmax(i)); mars_SI4(:,i)=q(5,:,end)'; energy_SI4(i)=e(end);
	[q,e]=NR_SolarSystemSimulator('RK4',Tmax,kmax(i)); mars_RK4(:,i)=q(5,:,end)'; energy_RK4(i)=e(end);
end
...
[q_truth,energy_truth]=NR_SolarSystemSimulator('RK4',Tmax,k_truth); mars_truth=q_truth(5,:,end)';
