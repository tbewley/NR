function [x,t,s]=NR_CNiter(R,x,t,s,p,v,SimPlot)
% function [x,t,s]=NR_CNiter(R,x,t,s,p,v,SimPlot)
...
% which contains the 1-2 most recent value(s) of f on input (from, e.g., a call to NR_CNiter),
% and the 2 most recent values of f on output (facilitating a call to NR_CNiter/NR_AM3iter).
...
% See also NR_AM3iter, NR_AM4iter, NR_AM5iter, NR_AM6iter.  Verify with NR_AMtest.
