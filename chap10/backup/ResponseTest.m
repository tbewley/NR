% script <a href="matlab:NR_ResponseTest">NR_ResponseTest</a>
% Test <a href="matlab:help NR_Response">NR_Response</a> by plotting the step response to a simple oscillatory system.
...
NR_Response(A,B,C,D,type,g)

% end script NR_ResponseTest
