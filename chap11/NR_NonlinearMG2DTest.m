function NR_NonlinearMG2DTest                           % Numerical Renaissance Codebase 1.0
...
for verbose=1:2
  NR_NonlinearMG2DInit(NX,NY), for l=1:nlev, betabar(l)=-beta/(4*g{l}.nx^2); end            
...
end % function NR_NonlinearMG2DTest
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function NR_NonlinearMG2DInit(NX,NY)
...
end % function NR_NonlinearMG2DInit
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function NR_NonlinearMG2D
global N1 verbose
...
% Apply Newton-Raphson red/black NR_Gauss-Seidel smoothing.                      *** NOTE ***
