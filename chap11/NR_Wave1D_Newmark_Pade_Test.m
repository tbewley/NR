% script <a href="matlab:NR_Wave1D_Newmark_Pade_Test">NR_Wave1D_Newmark_Pade_Test</a>
...
% See also NR_Wave1D_ItCN_Pade_Test, NR_Wave1D_ItCN_Pade_Test.
...
for k=1:4;
  ...
  disp(sprintf('Testing NR_Wave1D_ItCN_FD with N=%d, dt=%0.4g',N,dt));
  [q,x]=NR_Wave1D_Newmark_Pade(4,4,1.0,N,dt); grid; if k<4, pause; else, disp(' '), end

  figure(2); plot(x,q); pause(0.001);
end
% end script NR_Wave1D_Newmark_Pade_Test
