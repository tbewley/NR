function NR_Wave2D(v)                                % Numerical Renaissance Codebase 1.0
...
map=colormap('jet'); colormap(map(end:-1:1,:)); NR_SimPlot_ShallowWater(h,0,0,0,dt,dt,v,p,0); pause(1);
for t=0:dt:T;
  for i=1:p.Nxp;
end % function NR_Wave2D
