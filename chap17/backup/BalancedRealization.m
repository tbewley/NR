function [A,B,C,HankelSingularValues] = NR_BalancedRealization(A,B,C,MODE)
% function [A,B,C,HankelSingularValues] = NR_BalancedRealization(A,B,C,MODE)
...
% Verify with: <a href="matlab:help NR_BalancedRealizationTest">NR_BalancedRealizationTest</a>.

if nargin==3, MODE='CT'; end
P=NR_CtrbGrammian(A,B,MODE); Q=NR_ObsvGrammian(A,C,MODE); n=length(A); G=Cholesky(P,n);
...
end % function NR_BalancedRealization