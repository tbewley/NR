function [P,r] = NR_CtrbGrammian(A,B,MODE)
% function [P,r] = NR_CtrbGrammian(A,B,[MODE])
...
% Verify with: <a href="matlab:help NR_CtrbGrammianTest">NR_CtrbGrammianTest</a>.

if nargin==2, MODE='CT'; end, if MODE=='CT', P=NR_CALE(A,B*B'); else, P=NR_DALE(A,B*B'); end
if A==real(A), P=real(P); end, if nargout>1; [U,S,V,r]=SVD(P); end
end % function NR_CtrbGrammian
