% script <a href="matlab:CtrbGrammianTest">CtrbGrammianTest</a>
...
[P,rc]=CtrbGrammian(A,B,'CT'), e=Eig(P,'h'); Eigenvalues_of_P=e(N:-1:1);
...
[P,rc]=CtrbGrammian(F,G,'DT'), e=Eig(P,'h'); Eigenvalues_of_P=e(N:-1:1);
