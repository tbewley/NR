% script <a href="matlab:NR_CtrbGrammianTest">NR_CtrbGrammianTest</a>
...
[P,rc]=NR_CtrbGrammian(A,B,'CT'), e=NR_Eig(P,'h'); NR_Eigenvalues_of_P=e(N:-1:1);
...
[P,rc]=NR_CtrbGrammian(F,G,'DT'), e=NR_Eig(P,'h'); NR_Eigenvalues_of_P=e(N:-1:1);
...
% end script NR_CtrbGrammianTest