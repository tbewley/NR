function [A,B,C,rco,rcno,rnco,rncno] = KalmanDecomposition(A,B,C)
% function [A,B,C,rco,rcno,rnco,rncno] = KalmanDecomposition(A,B,C)
...
% Verify with: <a href="matlab:help CtrbGrammianTest">KalmanDecompositionTest</a>.
...
end % function KalmanDecomposition