function [A,B,C,rco,rcno,rnco,rncno] = NR_KalmanDecomposition(A,B,C)
% function [A,B,C,rco,rcno,rnco,rncno] = NR_KalmanDecomposition(A,B,C)
...
%                                     -----------------------------------------
%                                      C_co     0     C_nc,o    0     |   0
% See <a href="matlab:NRweb">Numerical Renaissance: simulation, optimization, & control</a>, Section 20.6.1.
...
% Verify with: <a href="matlab:help NR_CtrbGrammianTest">NR_KalmanDecompositionTest</a>.
...
end % function NR_KalmanDecomposition