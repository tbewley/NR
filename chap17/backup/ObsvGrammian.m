function [Q,r] = NR_ObsvGrammian(A,C,MODE)
% function [Q,r] = NR_ObsvGrammian(A,C,[MODE])
...
% Verify with: <a href="matlab:help NR_ObsvGrammianTest">NR_ObsvGrammianTest</a>.

if nargin==2, MODE='CT'; end, if MODE=='CT', Q=NR_CALE(A',C'*C); else, Q=NR_DALE(A',C'*C); end
if A==real(A), Q=real(Q); end, if nargout>1; [U,S,V,r]=SVD(Q); end
end % function NR_ObsvGrammian
