% script <a href="matlab:NR_ObsvGrammianTest">NR_ObsvGrammianTest</a>
...
[Q,rob]=NR_ObsvGrammian(A,C,'CT'), e=NR_Eig(Q,'h'); NR_Eigenvalues_of_Q=e(N:-1:1);
...
[Q,rob]=NR_ObsvGrammian(F,H,'DT'), e=NR_Eig(Q,'h'); NR_Eigenvalues_of_Q=e(N:-1:1);
...
% end script NR_ObsvGrammianTest