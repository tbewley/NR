% script <a href="matlab:NR_TF2SSTest">NR_TF2SSTest</a>
...
[Aco,Bco,Cco,Dco]=NR_TF2SS(b,a,'Reachability'); NR_ShowSys(Aco,Bco,Cco,Dco)
[bco,aco]=NR_SS2TF(Aco,Bco,Cco,Dco); ERRORco=norm(b-bco)+norm(a-aco), pause

disp(' '), disp('DTControllability form:')
[Act,Bct,Cct,Dct]=NR_TF2SS(b,a,'DTControllability'); NR_ShowSys(Act,Bct,Cct,Dct)
[bct,act]=NR_SS2TF(Act,Bct,Cct,Dct); ERRORct=norm(b-bct)+norm(a-act), pause
