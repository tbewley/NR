% script <a href="matlab:Sample">Sample</a>
% This sample script finds the eigenvalues and eigenvectors of a few random matrices
% constructed with special structure.
% Note: this sample script uses Matlab's built-in commands <a href="matlab:doc inv">inv</a> & <a href="matlab:doc eig">eig</a> (lower case).
% The text develops, from first principles, alternative algorithms <a href="matlab:help Inv">Inv</a> & <a href="matlab:help Eig">Eig</a> (mixed case).
